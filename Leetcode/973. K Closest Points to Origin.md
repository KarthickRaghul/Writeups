...
**Input:** points = [1,3](1,3), k = 1
**Output:** [-2,2](-2,2)
**Explanation:**
The distance between (1, 3) and the origin is sqrt(10).
The distance between (-2, 2) and the origin is sqrt(8).
Since sqrt(8) < sqrt(10), (-2, 2) is closer to the origin.
We only want the closest k = 1 points from the origin, so the answer is just [-2,2](-2,2).

**Example 2:**

**Input:** points = [3,3](3,3), k = 2
**Output:** [3,3](3,3)
**Explanation:** The answer [-2,4](-2,4) would also be accepted.
